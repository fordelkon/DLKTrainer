...
@dataclass
class VAETrainerConfig(BaseTrainerConfig):
    ##### base config #####
    ...
    epochs: int = 800 # number of epochs to train
    validation_epochs: int = 200 # do validation inference at `validation_epochs` times
    show_image_epochs: int = 40 # show validation images at `show_image_epochs` times
